<template>
  <div id="header" class="grid grid-cols-3 gap-4 w-screen h-20">
    <div id = "logo" class="self-center lg:w-96 mx-2 ">
      <router-link to="/">
      <img src="/assets/learning_icons_logo.svg" alt="Learning Icons Logo" >
      </router-link>
    </div>
    <div id ="menu" class="col-span-2 grid grid-cols-3 space-x-4 items-center font-roboto font-bold lg:text-xl">
