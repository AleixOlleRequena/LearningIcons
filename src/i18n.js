        ...
        resources: {
            en: {
                translation: {
                    ...
                    AltDescriptive: 'descriptive processing icon',
                    Diagnostic:'diagnostic processing',
                    AltDiagnostic: 'diagnostic processing icon',
                    Predictive: 'predictive processing',
                    AltPredictive: 'predictive processing icon',
                    Prescriptive:"prescriptive processing",
                    AltPrescriptive: 'prescriptive processing icon',

                    Cookies:"cookies",
                    AltCookies:"cookies icon",
                    Cache:"caching techniques",
                    AltCache:"caching techniques icon",
                    Personal:"personal data gathering",
                    AltPersonal:"personal data gathering icon",
                    General:"general data gathering",
                    AltGeneral:"general data gathering icon",
                    Metadata:"metadata gathering",
                    AltMetadata:"metadata gathering icon",
                    TransferExtern:"third-party data transfer",
                    AltTransferExtern:"third-party data transfer icon",
                    TransferIntern:"intern data transfer",
                    AltTransferIntern:"intern data transfer icon",
                    NotAnonymized:"no anonymized data",
                    AltNotAnonymized:"no anonymized data icon",
                    Anonymized:"anonymized data",
                    AltAnonymized:"anonymized data icon",
                    Stored:"data stored during x time",
                    AltStored:"data stored during x time icon",
                    Pseudoanonymized:"pseudoanonymized data",
                    AltPseudoanonymized:"pseudoanonymized data icon",
                    Encrypted:"Encrypted data",
                    AltEncrypted:"Encrypted data icon",
                    Processed:"data processed during x time",
                    AltProcessed:"data processed during x time icon",
                    ...
                    AltGiveYourOpinion: 'give your opinion image',
                    AltIconsImage: 'icons composition image'
            ...
            es:{
                translation: {
                    ...
                    AltDescriptive:'icono de análisis descriptivo',
                    Diagnostic:'análisis diagnóstico',
                    AltDiagnostic:'icono de análisis diagnóstico',
                    Predictive: 'análisis predictivo',
                    AltPredictive: 'icono de análisis predictivo',
                    Prescriptive: 'análisis prescriptivo',
                    AltPrescriptive: 'icono de análisis prescriptivo',
                    Cookies:"cookies",
                    AltCookies:"icono de cookies",
                    Cache:"técnicas de caché",
                    AltCache:"icono de técnicas de caché",
                    Personal:"recolección de datos personales",
                    AltPersonal:"icono de recolección de datos personales",
                    General:"recolección de datos generales",
                    AltGeneral:"icono de recolección de datos generales",
                    Metadata:"recolección de metadatos",
                    AltMetadata:"icono de recolección de metadatos",
                    TransferExtern:"transferencia de datos a terceros",
                    AltTransferExtern:"icono de transferencia de datos a terceros",
                    TransferIntern:"transferencia de datos interna",
                    AltTransferIntern:"icono de transferencia de datos interna",
                    NotAnonymized:"datos no anonimizados",
                    AltNotAnonymized:"icono de datos no anonimizados",
                    Anonymized:"datos anonimizados",
                    AltAnonymized:"icono de datos anonimizados",
                    Stored:"almacenamiento durante x tiempo",
                    AltStored:"icono de almacenamiento durante x tiempo",
                    Pseudoanonymized:"datos pseudoanonimizados",
                    AltPseudoanonymized:"icono de datos pseudoanonimizados",
                    Encrypted:"datos encriptados",
                    AltEncrypted:"icono de datos encriptados",
                    Processed:"datos tratados durante x tiempo",
                    AltProcessed:"icono de datos tratados durante x tiempo",
                    ...
                    GiveYourOpinion: 'ENVIA TU OPINIÓN',
                    AltGiveYourOpinion: 'imagen para "envia tu opinión"',
                    AltIconsImage: 'imagen compuesta por diferentes iconos'
                }
            }
        }
    });
